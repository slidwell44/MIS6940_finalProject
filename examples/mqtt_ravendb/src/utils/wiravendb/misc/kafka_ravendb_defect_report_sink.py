...
class WiKafkaDefectReportSink:
    def __init__(self):
        self.kafka_consumer: Consumer = Consumer(
            {
                "bootstrap.servers": "localhost:9092",
                "group.id": "ravendb-defect-report-sink",
                "auto.offset.reset": "earliest",
            }
        )

        self.consume_topic: McpKafkaTopics = McpKafkaTopics.DEFECT_REPORT.value
                ...
                if msg is None:
                    ...
                    try:
                        ...
                        with self.ravendb_store.open_session() as session:
                            ...
                            metadata["@collection"] = "kafka-defect-reports"
...
if __name__ == "__main__":
    defect_report_sink = WiKafkaDefectReportSink()
