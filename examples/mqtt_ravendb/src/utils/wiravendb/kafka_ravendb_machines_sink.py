...
class WiKafkaMachinesSink:
    def __init__(self):
        self.kafka_consumer: Consumer = Consumer(
            {
                "bootstrap.servers": "localhost:9092",
                "group.id": "ravendb-workorder-sink",
                "auto.offset.reset": "earliest",
            }
        )

        self.consume_topic: McpKafkaTopics = McpKafkaTopics.MACHINES.value
    ...
    def machines_ravendb_sink(self):
                ...
                if msg is None:
                    ...
                    try:
                        ...
                        with self.ravendb_store.open_session() as session:
                            ...
                            metadata["@collection"] = "kafka-machines"
...
if __name__ == "__main__":
    machines_sink = WiKafkaMachinesSink()
