...
class WiKafkaWorkOrderSink:
    def __init__(self):
        ...
        self.consume_topic: McpKafkaTopics = McpKafkaTopics.WORKORDER.value
                ...
                if msg is None:
                    ...
                    try:
                        ...
                        with self.ravendb_store.open_session() as session:
                            ...
                            metadata["@collection"] = "kafka-workorders"
...
if __name__ == "__main__":
    production_order_sink = WiKafkaWorkOrderSink()
